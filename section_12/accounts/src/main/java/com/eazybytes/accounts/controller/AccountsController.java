...
//    Controller layer is only responsible for
//    1. validate and accept the request
//    2. call service layer
//    3. return response

//  Whenever you have single constructor then you don't need to use @Autowired either in constructor or class level
    ...
    @Value("${build.version}") // following syntax of spring expression language
    ...
    // name = name of retry pattern
    @Retry(name = "getBuildInfo", fallbackMethod = "getBuildInfoFallback")
    @GetMapping("/build-info")
    public ResponseEntity<String> getBuildInfo() {
        logger.debug("getBuildInfo() method inside AccountsController invoked");
...
//        throw NullPointerException();
    ...
    // Here retry happens exactly 3 times
    // Fallback method for getBuildInfo
    public ResponseEntity<String> getBuildInfoFallback(Throwable throwable) {
        logger.debug("getBuildInfoFallback() method inside AccountsController invoked");
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    public ResponseEntity<String> getJavaVersionFallback(Throwable throwable) {
        logger.debug("getJavaVersionFallback() method inside AccountsController invoked");
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("Java 17"); // static value
    }
